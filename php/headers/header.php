...
<head>
  ...
  <script type="text/javascript">
    ...
    var formato_inv = "<?php if (isset($_SESSION['INGRESO']['Formato_Inventario'])) {
      echo $_SESSION['INGRESO']['Formato_Inventario'];
    } ?>";
                  ...
                  <ul class="menu">
                    <li><!-- start message -->
                      <a href="#">
                        ...
                        <p>
                          <?php if (isset($_SESSION['INGRESO']['Fecha'])) {
      ...
      <section class="sidebar">
        ...
        <div class="user-panel"
          ...
          <div class="main-header text-center">
            ...
            <?php } ?>
            <p class="text-gray" style="margin:0px">RUC:
