		...
		<form id="form_abonos">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-4" style="padding:0px">
					<b class="col-sm-7 col-xs-8 control-label" style="font-size: 11.5px;padding-right: 0px;"><input
							type="checkbox" name="CheqRecibo" id="CheqRecibo" checked> INGRESO CAJA No.</b>
					<div class="col-sm-5 col-xs-4" style="padding:0px">
						<input type="text" name="TxtRecibo" id="TxtRecibo" class="form-control input-sm"
							value="0000000">
					</div>
				</div>
				<div class="col-sm-4 col-xs-3" style="padding:0px">
					<b class="col-sm-6 col-xs-7" style="font-size: 11.5px; padding-top:5px">COTIZACION</b>
					<div class="col-sm-6 col-xs-5" style="padding:0px;">
						<input type="text" name="LabelDolares" id="LabelDolares"
							class="form-control input-sm text-right" value="0.00">
					</div>
				</div>
				<div class="col-sm-4 col-xs-5" style="padding:0px">
					<b class="col-sm-6 col-xs-6 control-label" style="font-size: 11.5px; padding-top:5px">Fecha del
						abono</b>
					<div class="col-sm-6 col-xs-6" style="padding: 0px">
						<input type="date" name="MBFecha" id="MBFecha" class="form-control input-sm"
			...
			<div class="row">
				<div class="col-sm-4 col-xs-4" style="padding:0px;">
					<b class="col-sm-7 col-xs-8 control-label"
				...
				<div class="col-sm-2 col-xs-2" style="padding:0px">
					<b class="col-sm-4 col-xs-4" style="padding: 10px 0px 0px 0px">Saldo</b>
					<div class="col-sm-8 col-xs-8" style="padding: 5px 0px 0px 0px">
						<input type="text" name="LabelSaldo" id="LabelSaldo" class="form-control input-sm text-right"
							value="0.00">
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-12 col-xs-12" style="padding:0px">
					<b class="col-sm-2 col-xs-2" style="padding: 10px 0px 0px 15px;">Autorizacion.</b>
					<div class="col-sm-10 col-xs-10" style="padding:5px 0px 0px 0px;">
			...
			<div class="row">
				<div class="col-sm-8 col-xs-8" style="padding:5px 0px 0px 15px">
					<input type="text" name="LblCliente" id="LblCliente" class="form-control input-sm"
						placeholder="Cliente">
					<input type="hidden" name="CodigoC" id="CodigoC" class="form-control input-sm"
						placeholder="Cliente">
					<input type="hidden" name="CI_RUC" id="CI_RUC" style="padding:5px 0px 0px 0px">
				</div>
				<div class="col-sm-4 col-xs-4" style="padding:5px 0px 0px 3px">
					<input type="text" name="LblGrupo" id="LblGrupo" class="form-control input-sm"
			...
			<div class="row">
				<div class="col-sm-2 col-xs-2">
					<b style="font-size: 11.5px;">Serie Retencion</b>
					<input type="text" name="TxtSerieRet" id="TxtSerieRet" class="form-control input-sm"
						placeholder="001" value="001001">
				</div>
				<div class="col-sm-2 col-xs-2">
					<b>Retencion No</b>
					<input type="text" name="TextCompRet" id="TextCompRet" class="form-control input-sm text-right"
						placeholder="00000000" value="99999999">
				</div>
				<div class="col-sm-8 col-xs-8" style="padding:0px 0px 0px 0px">
					<b>Autorizacion </b>
					<input type="text" name="TxtAutoRet" id="TxtAutoRet" class="form-control input-sm"
			...
			<div class="row">
				<div class="col-sm-8 col-xs-7">
					<div class="row">
						<div class="col-sm-10 col-xs-10">
							...
							<select class="form-control input-sm" id="DCRetIBienes" name="DCRetIBienes"
				...
				<div class="col-sm-4 col-xs-5" style="padding:0px"> <br>
					<b class="col-sm-7 col-xs-6" style="padding:0px 0px 0px 15px">VALOR RETENIDO.</b>
					<div class="col-sm-5 col-xs-6" style="padding:0px">
						<input type="text" name="TextRetIVAB" id="TextRetIVAB" class="form-control input-sm text-right"
							placeholder="0.00" value="0.00" onblur="Calculo_Saldo()">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-8 col-xs-7">
					<div class="row">
						<div class="col-sm-10 col-xs-10">
							...
							<select class="form-control input-sm" id="DCRetISer" name="DCRetISer"
				...
				<div class="col-sm-4 col-xs-5" style="padding:0px"> <br>
					<b class="col-sm-7 col-xs-6" style="padding:0px 0px 0px 15px">VALOR RETENIDO.</b>
					<div class="col-sm-5 col-xs-6" style="padding:0px">
						<input type="text" name="TextRetIVAS" id="TextRetIVAS" class="form-control input-sm text-right"
							placeholder="0.00" onblur="Calculo_Saldo()" value="0.00">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-8 col-xs-7">
					<div class="row">
						<div class="col-sm-6 col-xs-7" style="padding: 0px 0px 0px 15px;">
						...
						<div class="col-sm-4 col-xs-3" style="padding: 0px 0px 0px 15px;"><b>CODIGO </b>
						...
						<div class="col-sm-2 col-xs-2" style="padding:0px">
							<b>%</b>
							<input type="text" name="TextPorc" id="TextPorc" class="form-control input-sm"
								placeholder="000">
						</div>
					</div>
				</div>
				<div class="col-sm-4 col-xs-5" style="padding:0px"> <br>
					<b class="col-sm-7 col-xs-6" style="padding:0px 0px 0px 15px">VALOR RETENIDO.</b>
					<div class="col-sm-5 col-xs-6" style="padding:0px">
						<input type="text" name="TextRet" id="TextRet" class="form-control input-sm text-right"
							placeholder="00000000" onblur="Calculo_Saldo()" value="0.00">
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-3 col-xs-4" style="padding:0px"> <br>
					<b class="col-sm-6  col-xs-6" style="padding:0px 0px 0px 15px">VALOR.</b>
					<div class="col-sm-6 col-xs-6 " style="padding:0px">
						<input type="text" name="TextCheque" id="TextCheque" class="form-control input-sm text-right"
							placeholder="0.00" onblur="Calculo_Saldo()" value="0.00">
					</div>
				</div>
			</div>
				...
				<div class="col-sm-9 col-xs-8">
					<div class="row">
						<div class="col-sm-6 col-xs-5" style="padding-right: 0px;">
							...
							<select class="form-control input-sm" id="DCTarjeta" name="DCTarjeta"
						...
						<div class="col-sm-2 col-xs-3"><b>BAUCHER </b>
							<input type="text" name="TextBaucher" id="TextBaucher" class="form-control input-sm"
								placeholder="00000000">
						</div>
						<div class="col-sm-4 col-xs-4" style="padding:0px"><b>INTERES DE LA TARJETA</b>
							<input type="text" name="TextInteres" id="TextInteres"
								class="form-control input-sm text-right" placeholder="00000000" value="0"
				...
				<div class="col-sm-3 col-xs-4" style="padding:0px"> <br>
					...
					<div class="col-sm-6 col-xs-6 " style="padding:0px">
						<input type="text" name="TextTotalBaucher" id="TextTotalBaucher"
							class="form-control input-sm text-right" placeholder="00000000" onblur="Calculo_Saldo()"
							value="0.00">
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-sm-6 col-xs-6" style="padding-top:10px">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6" style="padding:0px 0px 0px 0px">
							<input type="text" name="TextCajaMN" id="TextCajaMN"
								class="form-control input-sm text-right" placeholder="00000000" value="0.00"
								style="padding:5px 0px 0px 3px">
						</div>
					</div>
					<div class="row">
