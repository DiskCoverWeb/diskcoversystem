...
<div class="row" style="margin:5px">
  <div class="col-sm-4 col-xs-12">
    ...
    <div class="col">
      <a href="javascript:void(0)" title="Visualizar" class="btn btn-default" onclick="">
        <img src="../../img/png/file2.png" width="25" height="30">
      </a>
    </div>

    <div class="col">
      <a href="javascript:void(0)" id="Enviar Rubros" title="Enviar Rubros" class="btn btn-default" onclick="">
        <img src="../../img/png/folder-check.png" width="25" height="30">
      </a>
    </div>
    <div class="col">
      <a href="javascript:void(0)" id="Recibir Rubos" title="Recibir Rubos" class="btn btn-default" onclick="">
        <img src="../../img/png/iess.png" width="25" height="30">
      </a>
    </div>
  </div>
  <div class="col-sm-8 col-xs-12">
    <div class="row">
      <div class="form-group col-xs-12 col-md-6 padding-all margin-b-1">
        <div class="col-xs-12">
          <label for="CheqProceso" class="col control-label" style="font-size: 13px;">
            <input tabindex="47" type="checkbox" name="CheqProceso" id="CheqCajero"> Procesar por Rangos Grupos
          </label>
        </div>
        <div class="col-xs-5">
          <select class="form-control input-xs" name="" id="" onchange="">
      ...
      <div class="col-xs-2">
        ...
        <input type='text' name='' id='' value='0' class='form-control input-xs'>
      </div>

      <div class='col-xs-4'>
        <label for='cuentaAcreditar' style='font-size: 13px;'>CUENTA A LA QUE SE VA ACREDITAR LOS ABONOS</label>
        <select class="form-control input-xs" name="" id="" onchange="">
          <option value="">Seleccione</option>
        </select>
      </div>
  ...
  <div class="panel panel-info">
    <div class="panel-heading">
      ...
      <div class="col-sm-8 col-xs-12">
        <div class="row">
          <div class="col-xs-3">
            <label for="fecha_factura" class="control-label">Facturación</label>
          </div>
          <div class="col-xs-3">
            <input tabindex="43" type="date" name="fecha_factura" id="fecha_factura"
              class="form-control input-xs validateDate" onchange="" title="Facturación"
              value="<?php echo date('Y-m-d') ?>">
          </div>
          <div class="col-xs-6">
            <label for="generar_matricula" class="control-label">
              <input tabindex="44" type="checkbox" name="generar_matricula" id="generar_matricula"> Generar Matrícula
            </label>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-xs-6">
            <label for="sin_deuda" class="control-label">
              <input tabindex="45" type="checkbox" name="sin_deuda" id="sin_deuda"> Sin Deuda Pendiente
            </label>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-3">
            <label for="fecha_pago" class="control-label">Tope de pago</label>
          </div>
          <div class="col-xs-3">
            <input tabindex="46" type="date" name="fecha_pago" id="fecha_pago"
              class="form-control input-xs validateDate" onchange="" title="Facturación"
              value="<?php echo date('Y-m-d') ?>">
          </div>
          <div class="col-xs-6">
            <label for="generar_matricula2" class="control-label">
              <input tabindex="47" type="checkbox" name="generar_matricula2" id="generar_matricula2"> Generar Matrícula
            </label>
          </div>
        </div>
      </div>
