...
<head>
  ...
  { 
     ...
     $.ajax({
      data:  {parametros:parametros},
      url:   '../controlador/login_controller.php?Ingresar_cartera=true',
      type:  'post',
      dataType: 'json',
      /*beforeSend: function () {   
           var spiner = '<div class="text-center"><img src="../../img/gif/proce.gif" width="100" height="100"></div>'     
...
<body>
	<div id="Contenedor" style="background:rgba(201, 223, 241,0.4);">
        ...
        <br>
         <button type="button" id="IngresoLog" name="submitlog"  class="btn btn-lg btn-primary btn-block btn-signin" onclick="/*Ingresar();*/Ingresar_vali()">Entrar en Cartera</button>
