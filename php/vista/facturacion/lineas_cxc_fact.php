				...
				<div class="tab-content">
				  <div id="home" class="tab-pane fade in active">
				    ...
				    <div class="col-sm-6">
					 ...
					 <?php 
					 	if($CodEntidad == "1"){
							echo '<div class="row"><div class="col-sm-12"><label><input type="checkbox" name="CheqPuntoEmision" id="CheqPuntoEmision"> Bloquear/Desbloquear Punto de Emisión</label></div></div>';
						}
					 ?>
