...
<script type="text/javascript">
  ...
  {    
    var url = '../controlador/facturacion/lista_notas_creditoC.php?Ver_retencion=true&retencion='+retencion+'&serie='+serie+'&numero='+numero;   
...
function catalogoLineas(){
  ...
  { 
    ...
    var parametros = 
    {
     ...
     $.ajax({
      data:  {parametros:parametros},
      url:   '../controlador/facturacion/lista_notas_creditoC.php?autorizar_retencion=true',
      type:  'post',
      dataType: 'json',
       success:  function (data) {
   ...
   function descargar_ret(retencion,serie,numero)
  {
    var parametros = 
    {
     ...
     $.ajax({
        data: {parametros:parametros},
        url:   '../controlador/facturacion/lista_notas_creditoC.php?descargar_retencion=true',
        dataType:'json',      
        type:  'post',
        // dataType: 'json',
        success:  function (response) { 
