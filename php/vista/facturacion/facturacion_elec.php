...
function mostara_observacion(opcion=1) {
    if(opcion===1){
    ...
    <div class="col-sm-4">
        ...
        <div class="input-group" id="ddl" style="width:100%">
            ...
            <span class="input-group-btn">
                <button type="button" class="btn btn-success btn-xs btn-flat" id="btn_nuevo_cli" onclick="addCliente()"
...
<div class="row">
    <div class="col-sm-9">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <label>1.- <input type="checkbox" name="rbl_obs" id="rbl_obs" onclick="mostara_observacion(1)">
                    </label>
                <label>2.- <input type="checkbox" name="rbl_obs_1" id="rbl_obs1" onclick="mostara_observacion(2)">
                    </label>
    ...
    <div class="col-sm-3">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <input type="text" name="LabelDescto" id="LabelDescto" class="form-control input-xs text-right"
                    value="0.00" style="color:red" readonly>
            </div>
        </div>
...
<div class="modal fade" id="modal_obs1" role="dialog" data-keyboard="false" data-backdrop="static" tabindex="-1">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            ...
            <div class="modal-body">
                <b>PO:</b>
                <input type="text" name="TxtPo" id="TxtPo" class="form-control input-xs" value="0">
                <b>MIGO:</b>
                <input type="text" name="TxtMigo" id="TxtMigo" class="form-control input-xs" value="0">
                <b>POSICION:</b>
                <input type="text" name="TxtPosicion" id="TxtPosicion" class="form-control input-xs" value="0">
                <b>PROV:</b>
                <input type="text" name="TxtProv" id="TxtProv" class="form-control input-xs" value="0">
                <b>CONDITION</b>
                <input type="text" name="TxtCondition" id="TxtCondition" class="form-control input-xs" value="0">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
