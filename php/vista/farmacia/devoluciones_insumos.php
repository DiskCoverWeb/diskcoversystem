      ...
      <div class="col-sm-8"> 
        <form method="post" id="filtro_bus" enctype="multipart/form-data">
            <div class="col-sm-6">
              ...
              <input type="text" name="txt_query" id="txt_query" class="form-control input-sm" placeholder="Nombre paciente" onkeypress="cargar_pedidos()" onblur="cargar_pedidos();cargar_pedidos_detalle()">
            </div>
            <div class="col-sm-3">
              <br>
              <b>FECHA INICIO</b>
              <input type="date" name="txt_desde" id="txt_desde" class="form-control input-sm" value="<?php echo date('Y-m-d')?>" onblur="cargar_pedidos('f');cargar_pedidos_detalle('f')">
            </div>
            <div class="col-sm-3">
              <br>
              <b>FECHA FIN</b>
              <input type="date" name="txt_hasta" id="txt_hasta" class="form-control input-sm" value="<?php echo date('Y-m-d')?>" onblur="cargar_pedidos('f');cargar_pedidos_detalle('f')">
            </div>
