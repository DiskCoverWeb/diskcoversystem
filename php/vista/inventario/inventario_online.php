       ...
       <div class="panel-heading">
        ...
        <div class="col-sm-12">
          ...
          <input type="hidden" name="txt_proyecto" id="txt_proyecto" class="form-control input-sm" value="<?php echo $proye; ?>">
               ...
               <div class="col-sm-2" style=" padding-left: 0px;  padding-right: 0px;width: 7%;">
                  <b>Codigo</b>
                  <input type="text" name="txt_codigo_" id="txt_codigo_" disabled="" class="form-control" style="padding: 0px 3px 0px 3px;">
                </div>
                ...
                <div class="col-sm-2"  style="padding-left: 2px;  padding-right: 0px;">
                 <div class="row">
                    <div class="col-sm-3" style="padding-right:  2px;">
                       <b>UNI</b>                  
                       <input type="" name="txt_uni_" id="txt_uni_" disabled="" class="form-control" style="padding: 6px 5px;">
                     </div>
                    <div class="col-sm-3" style="padding-left: 2px;  padding-right: 2px;">
                      <b>Stock </b>                        
                      <input type="text" class="form-control" name="txt_stock" id="txt_stock" readonly=""  style="padding: 6px 5px;">
                    </div>
                     <div class="col-sm-3" style="padding-left: 2px;  padding-right: 2px;">
                      <b>Presu. </b>                        
                      <input type="text" class="form-control" name="txt_presupuesto" id="txt_presupuesto" readonly="" title="Presupuestado" value="0" style="padding: 6px 5px;">                     </div>
                     <div class="col-sm-3" style="padding-left: 2px;  padding-right: 7px;">
                      <b>consu.</b>                        
                      <input type="text" class="form-control" name="txt_consumido" id="txt_consumido" readonly="" value="0" title="Consumido" style="padding: 6px 5px;">
                    </div>
                  </div>
                </div>
                <div class="col-sm-1"  style=" padding-left: 10px;  padding-right: 2px; width: 6%;">
                  <b>Cantidad</b>
                  <input name="txt_cant_" id="txt_cant_" placeholder="Cantidad" class="form-control" onblur="validar_stock()" value="0" type="text" onkeyup="comprueba_negativos('cant')">
                </div>
