...
<head>
    <style>
        ...
        .contenedor-cf, .mensaje-form-enviado{
            position: absolute;
            display: flex;
        ...
        /*.encabezado{
            background-image: linear-gradient(115deg, rgb(17 69 89 / 85%), rgb(149 148 148 / 73%)), url(../../img/inscripcion/header.png);
        }*/

        .encabezado{
            /*background-image: linear-gradient(115deg, rgb(76 0 255 / 85%), rgb(161 0 0 / 73%)), url(../../img/inscripcion/header.png);*/
            background-image: linear-gradient(115deg, rgb(68 176 255 / 90%), rgb(7 191 106 / 70%)), url(../../img/inscripcion/header.png);
        ...
        .f-seccion{
            border-radius: 10px;
            padding: 25px;
            box-shadow: 1px 2px 5px 0px #0000003a;
            margin: 0 0 18px 0;
        ...
        <div class="accordion" id="accordionExample" style="margin-top:0px; margin-left:30px; margin-right: 30px;">
                ...
                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                    ...
                    <div class="card-body" style="margin: 1px; padding-top: 5px; padding-bottom: 5px;">
                        ...
                        <div class="row" style="margin: 10px; display: flex; justify-content: center;">
                            ...
                            <div class="col-sm-6 col-md-2 campoVolNo"
            ...
            <div class="card">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                    ...
                    <div id="mostrarVoluntariosAdd" class="card-body">
