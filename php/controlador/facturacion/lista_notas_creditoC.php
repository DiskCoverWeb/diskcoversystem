   ...
   function tabla_facturas($parametros)
    {
    	...
    	foreach ($tbl as $key => $value) {
            ...
            <div class="input-group-btn">
					...
					<li><a href="#" onclick="Ver_retencion(\''.$value['Secuencial_NC'].'\',\''.$value['Serie_NC'].'\',\''.$value['Factura'].'\')"><i class="fa fa-eye"></i> Ver Retencion</a></li>';
					...
					{
						$tr.='<li><a class="btn-danger"><i class="fa fa-info"></i>Para autorizar Asigne el catalo de lineas la serie:'.$value['Serie_NC'].'</a></li>';
					}
					if($value['T']!='A')
					{
						$tr.='<li><a href="#" onclick="anular_factura(\''.$value['Secuencial_NC'].'\',\''.$value['Serie_NC'].'\',\''.$value['Codigo'].'\')"><i class="fa fa-times-circle"></i>Anular Retencion</a></li>';
					}
					$tr.='<li><a href="#" onclick=" modal_email_ret(\''.$value['Secuencial_NC'].'\',\''.$value['Serie_NC'].'\',\''.$value['Factura'].'\',\''.$value['Autorizacion_NC'].'\',\''.$email.'\')"><i class="fa fa-envelope"></i> Enviar Retencion por email</a></li>
					<li><a href="#" onclick="descargar_ret(\''.$value['Secuencial_NC'].'\',\''.$value['Serie_NC'].'\',\''.$value['Factura'].'\')"><i class="fa fa-download"></i> Descargar Retencion</a></li>';
